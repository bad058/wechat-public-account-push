export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx9d603fa956f197ee",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "5cdf67f2e55d387be07459a0b0e8cb7f",
  ...
  USERS: [
    {
      ...
      id: "o_6a45nfdV2_YSQ6ObxDe7G3r6sE",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "tLNizEe6Y6jLS9t3bszr9bLnjSAvsscY_mwARVqaEr8",
      // 所在省份
      province: "广西",
      // 所在城市
      city: "南宁",
      ...
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2021-11-25"},
      ]
    },
    {
      name: "老婆1",
